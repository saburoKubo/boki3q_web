(function () {
  ...
  const accountGroupOrder = [
    ["現金", "小口現金", "普通預金", "当座預金", "売掛金", "クレジット売掛金", "受取手形", "電子記録債権", "受取商品券", "繰越商品", "消耗品", "前払金", "前払家賃", "前払保険料", "仮払金", "仮払消費税", "仮払法人税等", "未収入金", "未収手数料", "従業員立替金", "貯蔵品", "差入保証金", "備品", "備品減価償却累計額", "建物", "土地", "貸倒引当金"],
    ["買掛金", "支払手形", "電子記録債務", "未払金", "未払給料", "未払利息", "未払消費税", "未払法人税等", "未払配当金", "前受金", "前受手数料", "仮受金", "仮受消費税", "所得税預り金", "住民税預り金", "社会保険料預り金", "借入金", "手形借入金", "当座借越"],
    ["資本金", "繰越利益剰余金", "利益準備金"],
    ["仕入", "給料", "支払家賃", "旅費交通費", "通信費", "消耗品費", "保険料", "法定福利費", "租税公課", "修繕費", "発送費", "支払手数料", "支払利息", "手形売却損", "売上割引", "減価償却費", "貸倒引当金繰入", "貸倒損失", "貯蔵品消耗費", "固定資産売却損", "固定資産除却損", "雑費", "法人税、住民税及び事業税"],
    ["売上", "受取手数料", "償却債権取立益", "貸倒引当金戻入", "固定資産売却益", "仕入割引"],
    ["現金過不足", "損益"]
  ];
